...
اگر هر دو ping شکست خوردند، پیش از تغییر route یا NAT، برنامه دیباگ مرحله‌به‌مرحله [`DEBUG5.md`](DEBUG5.md) را اجرا کنید. شکست هر دو ping در baseline این مرحله می‌تواند ناشی از نبود مسیر برگشت روی `Internet` و رفتار مورد انتظار آزمایش باشد.
